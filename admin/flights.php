...
$extraHead = '
    ...
    <style>
        ...
        .bottom-shelf { height: 260px; flex-shrink: 0; display: flex; flex-direction: column; margin-top: auto; }
...
<div class="flex-1 flex flex-col justify-end z-10 max-h-full overflow-hidden">
    ...
    <div class="bottom-shelf glass-panel rounded-3xl overflow-hidden">
